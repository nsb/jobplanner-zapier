...
describe('myjobplanner app', () => {
  ...
  it('generates an authorize URL', (done) => {
    const bundle = {
      ...
      inputData: {
        state: '4444',
        redirect_uri: 'https://api.myjobplanner.com/'
      },
      environment: {
    ...
    appTester(App.authentication.oauth2Config.authorizeUrl, bundle)
      .then((authorizeUrl) => {
        authorizeUrl.should.eql('https://api.myjobplanner.com/o/authorize/?client_id=1234&state=4444&redirect_uri=https%3A%2F%2Fapi.myjobplanner.com%2F&response_type=code');
        done();
      })
      .catch(done);
  });
  ...
  it('should load businesses', (done) => {
     const triggerPointer = 'triggers.business';
     const bundle = {};
